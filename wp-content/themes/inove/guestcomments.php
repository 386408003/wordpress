...
<div id="cmtswitcher">
	<?php if(pings_open()) : ?>
		<a id="commenttab" class="curtab" href="javascript:void(0);" onclick="MGJS.switchTab('thecomments,commentnavi', 'thetrackbacks', 'commenttab', 'curtab', 'trackbacktab', 'tab');"><?php _e('Messages', 'inove'); echo (' (' . (count($comments)-count($trackbacks)) . ')'); ?></a>
		
	<?php else : ?>
		<a id="commenttab" class="curtab" href="javascript:void(0);"><?php _e('Messages', 'inove'); echo (' (' . (count($comments)-count($trackbacks)) . ')'); ?></a>
	<?php endif; ?>
	<?php if(comments_open()) : ?>
		<span class="addcomment"><a href="#respond"><?php _e('Leave a message', 'inove'); ?></a></span>
	<?php endif; ?>
	...
	<div id="respond">
		...
		<div id="submitbox">
			...
			<div class="submitbutton">
				<input name="submit" type="submit" id="submit" class="button" tabindex="5" value="<?php _e('Submit Message', 'inove'); ?>" />
			</div>
